 ...
 */
export declare function validateUriPathSegment(propertyName: string, value: string): void;
/**
 ...
 */
export declare function validateUriPath(propertyName: string, value: string): void;
/**
 ...
 */
export declare function encodeAbsoluteURI(uri: string): string;
/**
 ...
 */
export declare function joinURIComponents(components: string[]): string;
