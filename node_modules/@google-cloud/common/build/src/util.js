...
exports.validateUriPathSegment = validateUriPathSegment;
exports.validateUriPath = validateUriPath;
...
exports.encodeAbsoluteURI = encodeAbsoluteURI;
exports.joinURIComponents = joinURIComponents;
/*!
 * @module common/util
 */
...
function encodeWithSlashes(str) {
    return encodeURIComponent(str).replace(/[!'()*]/g, // Characters preserved by encodeURIComponent
    // Characters preserved by encodeURIComponent
 ...
 */
function encodeAbsoluteURI(uri) {
 ...
 */
function joinURIComponents(components) {
    return components
        .map(uriComponent => {
